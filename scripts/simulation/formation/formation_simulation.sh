...
xterm -hold -e "./gams_controller -i 0 -n $NUM -p vrep -lt $TIME -pd $PERIOD -mf scripts/simulation/formation/madara_init_0.mf scripts/simulation/areas/20.mf scripts/simulation/madara_init_common.mf -l $MADARA_DEBUG" &
xterm -hold -e "./gams_controller -i 1 -n $NUM -p vrep -lt $TIME -pd $PERIOD -mf scripts/simulation/formation/madara_init_1.mf scripts/simulation/areas/20.mf scripts/simulation/madara_init_common.mf -l $MADARA_DEBUG" &
xterm -hold -e "./gams_controller -i 2 -n $NUM -p vrep -lt $TIME -pd $PERIOD -mf scripts/simulation/formation/madara_init_2.mf scripts/simulation/areas/20.mf scripts/simulation/madara_init_common.mf -l $MADARA_DEBUG" &
