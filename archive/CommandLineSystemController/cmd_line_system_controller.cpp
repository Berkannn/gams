...
int main (int argc, char** argv)
{
    ...
    g_madaraController->setParamNumDrones(numDrones);
    g_madaraController->setParamCommRange(commRange);
    g_madaraController->setParamMinAltitude(minHeight);
    g_madaraController->setParamHeightDiff(heightDiff);
    g_madaraController->disseminateParameters();
